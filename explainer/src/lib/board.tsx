...
import { COL_LETTERS } from "./format"

/**
 * GomokuBoard — hand-drawn SVG board (same craft as the training console).
 * Wood surface, hairline grid, star points, gradient stones, cinnabar
 * last-move marker, policy heat discs, top-move bubbles, hover ghost.
 */
...
interface GomokuBoardProps {
  ...
  /** Flat N*N probabilities (0..1) rendered as accent heat discs. */
  heat?: number[]
